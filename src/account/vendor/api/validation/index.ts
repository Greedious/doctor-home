...
import { CreateVendorRequest, UpdateVendor } from '../dto/request';
...
export class VendorValidation {
  create({ body }: { body: CreateVendorRequest }) {
    const create = joi.object<CreateVendorRequest>({
  ...
  update({ body, params }: { body: UpdateVendor; params: Params }) {
